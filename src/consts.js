...
export const activeTechnologies = [
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__private-cloud.svg',
    id: 'infrastructure',
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__update.svg',
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__build-deploy.svg',
    id: 'build-deploy',
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__control-panel.svg',
    id: 'zero-install',
    title: 'Zero install',
    text: (
      <p>
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__hybrid-cloud.svg',
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__exp-up.svg',
    id: 'insights',
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__padlock.svg',
    id: 'customers',
  ...
  {
    keyFeature: true,
    icon: 'https://console.redhat.com/apps/frontend-assets/icons/icon__modernize.svg',
    id: 'modernize',
